...
class ConnectedAccountsController < ApplicationController
  ...
  def create
    begin
      Current.organization.set_merchant_processor(:stripe)
      Current.organization.merchant_processor.create_account
      ...
      account_link = Current.organization.merchant_processor.account_link(
  ...
  def dashboard
    begin
      ...
      # and is guaranteed to be a valid Stripe domain (connect.stripe.com)
      login_link = Current.organization.merchant_processor.login_link
  ...
  def sync
    begin
      merchant = Current.organization.merchant_processor
  ...
  # Ensure organization has active subscription before connecting account
